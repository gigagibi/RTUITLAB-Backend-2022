...
public interface DeliveryOrderMapper extends CommonMapper<DeliveryOrderDocument, DeliveryOrderGetDTO, DeliveryOrderPostDTO, DeliveryOrderPutDTO, DeliveryOrderPostedDTO, DeliveryOrderUpdatedDTO> {
    DeliveryOrderDocument deliveryOrderFromDeliveriesToEntity(DeliveryOrderFromDeliveriesDTO deliveryOrderFromDeliveriesDTO);
    DeliveryOrderToDeliveriesDTO entityToDeliveryOrderToDeliveries(DeliveryOrderDocument deliveryOrderDocument);
}